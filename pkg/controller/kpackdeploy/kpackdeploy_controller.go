...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner KpackDeploy
	//err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
	//	IsController: true,
	//	OwnerType:    &kpackdeployv1alpha1.KpackDeploy{},
	//})
	//if err != nil {
	//	return err
	//}
...
func (r *ReconcileKpackDeploy) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	//
	//// Set KpackDeploy instance as the owner and controller
...
//func newPodForCR(cr *kpackdeployv1alpha1.KpackDeploy) *corev1.Pod {
